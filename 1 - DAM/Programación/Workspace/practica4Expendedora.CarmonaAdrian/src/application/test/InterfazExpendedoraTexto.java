...
public class InterfazExpendedoraTexto {
	...
	public static void main(String[] args) {
		...
		Expendedora e = new Expendedora(10, new String[] { "Agua 1L", "Cola", "Naraja" }, new double[] { 0.9, 1, 1.2 },
				new int[] { 2, 3, 4 });
	...
	public static void realizarSimulacion(Expendedora e){
		...
		// Mostrar repetidamente el menu y actuar segun lo elegido por el usuario.
	 ...
	 * usuario elije una opcion valida, el metodo la devuelve. Las opciones validas
	 * iran de la 0 al numero de opciones - 1.
	 * 
	 * @param opciones Array de String con las opciones que se mostraran
	...
	/**
	 * Lee un entero y lo devuelve. El metodo no termina hasta que consigue leer un
	 * entero correctamente.
	 * 
	...
	/**
	 * Lee un numero real y lo devuelve. El metodo no termina hasta que consigue
